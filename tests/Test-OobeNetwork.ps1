        ...
        & {
            ...
            switch($case){
                ...
                'wait-completion'{
                    ...
                    & $guest -Mode finalize-wait -Direct
                ...
                'timeout'{
                    Assert-Throws {& $guest -Mode finalize-wait -Direct -WaitSeconds 1} 'Wait timeout reports a failure'
                ...
                'temporary-user'{
                    $env:USERNAME='defaultuser1';[Win11Lite.Oobe]::Complete=$true
                    & $guest -Mode finalize -Direct
                ...
                'firewall-failure'{
                    [Win11Lite.Oobe]::Complete=$true;$state.FirewallRemoveFails=$true
                    & $guest -Mode finalize -Direct
                ...
                'adapter-failure'{
                    [Win11Lite.Oobe]::Complete=$true;$state.EnableFails=$true
                    & $guest -Mode finalize -Direct
                ...
                'firewall-query-failure'{
                    [Win11Lite.Oobe]::Complete=$true;$state.FirewallQueryFails=$true
                    & $guest -Mode finalize -Direct

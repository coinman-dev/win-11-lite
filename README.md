...
На 12.09.2026 прошли **491 проверка на каждой версии PowerShell**: 5.1 и 7. Наборы выполняются отдельными процессами; системные API, сеть и DISM в соответствующих тестах подменены.
